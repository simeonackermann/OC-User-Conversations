...
<?php else: ?>
	...
	<div id="app-content"><div id="no-users"><p>Please add some other users or groups in <a href="<?php echo OCP\Util::linkTo( 'index.php/settings', 'users' ); ?>">ownCloud user settings</a> to start chatting...</p></div></div>
